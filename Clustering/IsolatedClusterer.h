/**
 * \file IsolatedClusterer.h
 *
 * \ingroup Clusterer
 * 
 * \brief Class def header for a class IsolatedClusterer
 *
...
#ifndef LARLITE_ISOLATEDCLUSTERER_H
#define LARLITE_ISOLATEDCLUSTERER_H
...
namespace larlite {
  /**
     \class IsolatedClusterer
     User custom analysis class made by SHELL_USER_NAME
   */
  class IsolatedClusterer : public ana_base{
  ...
  public:
    ...
    /// Default destructor
    virtual ~IsolatedClusterer(){}

    /** IMPLEMENT in IsolatedClusterer.cc!
