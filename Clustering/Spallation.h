 ...
 * \ingroup Clusterer
 * 
 * \brief Class def header for a class Spallation
 *
...
#ifndef LARLITE_SPALLATION_H
#define LARLITE_SPALLATION_H
...
namespace larlite {
   ...
   */
  class Spallation : public ana_base{
  ...
  protected:
    ...
    /// get list of cells which contain a cluster
    std::vector< std::pair<int,int> > GetCells(const event_hit* ev_hit,
